...
{
    public class IsTheNameOfAnExistingTaxReportingCategory : IArgumentValidator
    {
        public const string NameDoesNotExistMessageText = "A {0} with that name does not exist.";
