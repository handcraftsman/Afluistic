...
{
    public class ListTaxReportingCategories : ICommand
    {
        public const string UsageMessageText = "\tLists the supported {0}.";
        private readonly ISystemService _systemService;

        public ListTaxReportingCategories(ISystemService systemService)
        {
        ...
        [RequireStatement]
        [RequireTaxReportingCategoriesExist]
        ...
        public void WriteUsage(TextWriter textWriter)
        {
            ...
            textWriter.WriteLine(UsageMessageText, typeof(TaxReportingCategory).GetPluralUIDescription());
        }
    }
}